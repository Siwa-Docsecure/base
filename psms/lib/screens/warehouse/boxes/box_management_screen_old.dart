...
//                     child: Text('${client.clientName} (${client.clientCode})'),
//                   ),
//                 ),
//               ],
...
//             final clientId = selectedClientId.value == 0 ? null : selectedClientId.value;
//             final report = await boxController.getBoxReport(clientId: clientId);
//             if (report == null) {
...
//                 children: [
//                   Text('PDF Preview', style: TextStyle(fontWeight: FontWeight.bold)),
//                   IconButton(
...
//                 allowSharing: true,
//                 allowPrinting: true,
//                 pdfFileName: 'box_report_${DateFormat('yyyyMMdd_HHmm').format(DateTime.now())}.pdf',
//               ),
//             ),
//             Padding(
//               padding: EdgeInsets.all(16),
...
//                       pw.Text('Document Management Services',
//                           style: pw.TextStyle(fontSize: 10, color: PdfColors.grey700)),
//                       pw.SizedBox(height: 4),
//                       pw.Text('123 Business Ave, City, State 12345',
...
//           headers: ['Box #', 'Size', 'Description', 'Date Received', 'Year', 'Status'],
//           data: report.boxes.map((box) => [
//                 box.boxNumber,
//                 box.boxSize,
//                 box.description ?? '',
//                 box.datesRange ?? '',
...
//   final file = File('${tempDir.path}/box_report_${DateFormat('yyyyMMdd_HHmm').format(DateTime.now())}.pdf');
...
//                 mainAxisAlignment: MainAxisAlignment.spaceBetween,
//                 children: [
//                   Text('Excel Preview', style: TextStyle(fontWeight: FontWeight.bold)),
//                   IconButton(
//                     icon: Icon(Icons.close),
//                     onPressed: () => Get.back(),
//                   ),
...
//                     onPressed: () async {
//                       Get.back(); // close preview
//                       await _generateAndShareExcel(report, clientId: clientId);
//                     },
...
//   final fileName = 'box_report_${DateFormat('yyyyMMdd_HHmm').format(DateTime.now())}.xlsx';
